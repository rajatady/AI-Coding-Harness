...
use figma_engine::node::{CornerRadii, PathCommand};
use figma_engine::properties::{Color, Effect, FillRule, GradientStop, Paint, PremultColor, Transform};
...
pub struct RenderStyle {
    ...
    pub stroke_align: figma_engine::properties::StrokeAlign,
    pub stroke_cap: figma_engine::properties::StrokeCap,
    pub stroke_join: figma_engine::properties::StrokeJoin,
    pub opacity: f32,
}
...
fn rasterize_stroke_internal(
    ...
    world_transform: &Transform,
    weight: f32,
    align: figma_engine::properties::StrokeAlign,
    cap: figma_engine::properties::StrokeCap,
    join: figma_engine::properties::StrokeJoin,
) {
