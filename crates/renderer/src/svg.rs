...
use figma_engine::node::NodeKind;
use figma_engine::properties::{Color, Paint, Transform};
...
fn path_commands_to_d(commands: &[figma_engine::node::PathCommand]) -> String {
    use figma_engine::node::PathCommand;
