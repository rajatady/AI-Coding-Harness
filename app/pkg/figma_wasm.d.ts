...
export class FigmaApp {
     ...
     */
    get_node_children(counter: number, client_id: number): string;
    /**
...
export interface InitOutput {
    ...
    readonly __wbg_figmaapp_free: (a: number, b: number) => void;
    readonly figmaapp_add_blur: (a: number, b: number, c: number, d: number) => number;
    readonly figmaapp_add_comment: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
    readonly figmaapp_add_drop_shadow: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => number;
    readonly figmaapp_add_ellipse: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => [number, number];
    readonly figmaapp_add_frame: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => [number, number];
    readonly figmaapp_add_gradient_rectangle: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number) => [number, number];
    readonly figmaapp_add_image: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => [number, number];
    readonly figmaapp_add_image_fill: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => [number, number];
    readonly figmaapp_add_inner_shadow: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => number;
    readonly figmaapp_add_line: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => [number, number];
    readonly figmaapp_add_node_fill: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
    readonly figmaapp_add_node_linear_gradient: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => number;
    readonly figmaapp_add_node_radial_gradient: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => number;
    readonly figmaapp_add_page: (a: number, b: number, c: number) => number;
    readonly figmaapp_add_prototype_link: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
    readonly figmaapp_add_rectangle: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => [number, number];
    readonly figmaapp_add_rounded_rect: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => [number, number];
    readonly figmaapp_add_star: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => [number, number];
    readonly figmaapp_add_text: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number) => [number, number];
    readonly figmaapp_add_vector: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number) => [number, number];
    readonly figmaapp_align_selected: (a: number, b: number) => number;
    readonly figmaapp_apply_remote_ops: (a: number, b: number, c: number) => number;
    readonly figmaapp_boolean_op: (a: number, b: number) => number;
    readonly figmaapp_bring_forward: (a: number) => number;
    readonly figmaapp_bring_to_front: (a: number) => number;
    readonly figmaapp_cancel_creating: (a: number) => void;
    readonly figmaapp_clear_insert_parent: (a: number) => void;
    readonly figmaapp_comment_count: (a: number) => number;
    readonly figmaapp_copy_selected: (a: number) => number;
    readonly figmaapp_create_component: (a: number) => [number, number];
    readonly figmaapp_create_instance: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_current_page_index: (a: number) => number;
    readonly figmaapp_delete_comment: (a: number, b: number) => number;
    readonly figmaapp_delete_selected: (a: number) => number;
    readonly figmaapp_detach_instance: (a: number) => number;
    readonly figmaapp_distribute_selected: (a: number, b: number) => number;
    readonly figmaapp_drawn_count: (a: number) => number;
    readonly figmaapp_duplicate_selected: (a: number) => number;
    readonly figmaapp_exit_group: (a: number) => void;
    readonly figmaapp_export_document_json: (a: number) => [number, number];
    readonly figmaapp_export_pixels: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_export_svg: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_find_nodes_by_name: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_find_nodes_with_image: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_flatten_selected: (a: number) => number;
    readonly figmaapp_get_all_image_keys: (a: number) => [number, number];
    readonly figmaapp_get_camera: (a: number) => [number, number];
    readonly figmaapp_get_comments: (a: number) => [number, number];
    readonly figmaapp_get_creation_preview: (a: number) => [number, number];
    readonly figmaapp_get_entered_group: (a: number) => [number, number];
    readonly figmaapp_get_imported_image: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_get_layers: (a: number) => [number, number];
    readonly figmaapp_get_layers_range: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_get_marquee_rect: (a: number) => [number, number];
    readonly figmaapp_get_node_children: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_get_node_info: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_get_node_name: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_get_node_world_bounds: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_get_pages: (a: number) => [number, number];
    readonly figmaapp_get_pending_ops: (a: number) => [number, number];
    readonly figmaapp_get_prototype_links: (a: number) => [number, number];
    readonly figmaapp_get_selected: (a: number) => [number, number];
    readonly figmaapp_get_snap_grid: (a: number) => number;
    readonly figmaapp_get_text_arc: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_get_tree_layers: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    readonly figmaapp_get_vector_network: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_get_visible_image_fills: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_group_selected: (a: number) => number;
    readonly figmaapp_handle_double_click: (a: number, b: number, c: number) => number;
    readonly figmaapp_import_document_json: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_import_fig_binary: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_import_fig_json: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    readonly figmaapp_import_fig_page_json: (a: number, b: number, c: number, d: number, e: number) => [number, number];
    readonly figmaapp_is_creating: (a: number) => number;
    readonly figmaapp_is_rotation_zone: (a: number, b: number, c: number) => number;
    readonly figmaapp_is_vector_editing: (a: number) => number;
    readonly figmaapp_layer_count: (a: number) => number;
    readonly figmaapp_mouse_down: (a: number, b: number, c: number, d: number) => number;
    readonly figmaapp_mouse_move: (a: number, b: number, c: number) => void;
    readonly figmaapp_mouse_up: (a: number) => void;
    readonly figmaapp_needs_render: (a: number) => number;
    readonly figmaapp_new: (a: number, b: number, c: number) => number;
    readonly figmaapp_node_count: (a: number) => number;
    readonly figmaapp_page_count: (a: number) => number;
    readonly figmaapp_pan_end: (a: number) => void;
    readonly figmaapp_pan_move: (a: number, b: number, c: number) => void;
    readonly figmaapp_pan_start: (a: number, b: number, c: number) => void;
    readonly figmaapp_paste: (a: number) => number;
    readonly figmaapp_pen_cancel: (a: number) => void;
    readonly figmaapp_pen_finish_closed: (a: number) => void;
    readonly figmaapp_pen_finish_open: (a: number) => void;
    readonly figmaapp_pen_get_state: (a: number) => [number, number];
    readonly figmaapp_pen_is_active: (a: number) => number;
    readonly figmaapp_pen_mouse_down: (a: number, b: number, c: number) => void;
    readonly figmaapp_pen_mouse_drag: (a: number, b: number, c: number) => void;
    readonly figmaapp_pen_mouse_move: (a: number, b: number, c: number) => void;
    readonly figmaapp_pen_mouse_up: (a: number) => void;
    readonly figmaapp_pen_start: (a: number) => void;
    readonly figmaapp_prototype_link_count: (a: number) => number;
    readonly figmaapp_redo: (a: number) => number;
    readonly figmaapp_remove_auto_layout: (a: number, b: number, c: number) => number;
    readonly figmaapp_remove_node_stroke: (a: number, b: number, c: number) => number;
    readonly figmaapp_remove_prototype_links: (a: number, b: number, c: number) => number;
    readonly figmaapp_rename_page: (a: number, b: number, c: number, d: number) => number;
    readonly figmaapp_render: (a: number, b: number, c: number) => [number, number];
    readonly figmaapp_render_canvas2d: (a: number, b: any, c: number, d: number, e: number) => void;
    readonly figmaapp_resolve_comment: (a: number, b: number, c: number) => number;
    readonly figmaapp_select_all: (a: number) => void;
    readonly figmaapp_select_node: (a: number, b: number, c: number) => void;
    readonly figmaapp_send_backward: (a: number) => number;
    readonly figmaapp_send_to_back: (a: number) => number;
    readonly figmaapp_set_auto_layout: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number) => number;
    readonly figmaapp_set_camera: (a: number, b: number, c: number, d: number) => void;
    readonly figmaapp_set_dash_pattern: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly figmaapp_set_image_fill: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
    readonly figmaapp_set_insert_parent: (a: number, b: number, c: number) => void;
    readonly figmaapp_set_letter_spacing: (a: number, b: number, c: number, d: number) => number;
    readonly figmaapp_set_line_height: (a: number, b: number, c: number, d: number) => number;
    readonly figmaapp_set_node_angular_gradient: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => number;
    readonly figmaapp_set_node_blend_mode: (a: number, b: number, c: number, d: number) => number;
    readonly figmaapp_set_node_constraints: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly figmaapp_set_node_corner_radius: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
    readonly figmaapp_set_node_fill: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
    readonly figmaapp_set_node_fills_json: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly figmaapp_set_node_font_family: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly figmaapp_set_node_font_size: (a: number, b: number, c: number, d: number) => number;
    readonly figmaapp_set_node_font_weight: (a: number, b: number, c: number, d: number) => number;
    readonly figmaapp_set_node_linear_gradient: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => number;
    readonly figmaapp_set_node_mask: (a: number, b: number, c: number, d: number) => number;
    readonly figmaapp_set_node_name: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly figmaapp_set_node_opacity: (a: number, b: number, c: number, d: number) => number;
    readonly figmaapp_set_node_position: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly figmaapp_set_node_radial_gradient: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number) => number;
    readonly figmaapp_set_node_rotation: (a: number, b: number, c: number, d: number) => number;
    readonly figmaapp_set_node_size: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly figmaapp_set_node_stroke: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
    readonly figmaapp_set_node_text: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly figmaapp_set_snap_grid: (a: number, b: number) => void;
    readonly figmaapp_set_stroke_align: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly figmaapp_set_text_align: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly figmaapp_set_text_arc: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
    readonly figmaapp_set_text_decoration: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly figmaapp_set_text_gradient_fill: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number) => number;
    readonly figmaapp_set_text_vertical_align: (a: number, b: number, c: number, d: number, e: number) => number;
    readonly figmaapp_set_viewport: (a: number, b: number, c: number) => void;
    readonly figmaapp_start_creating: (a: number, b: number, c: number) => void;
    readonly figmaapp_switch_page: (a: number, b: number) => number;
    readonly figmaapp_toggle_select_node: (a: number, b: number, c: number) => void;
    readonly figmaapp_total_node_count: (a: number) => number;
    readonly figmaapp_undo: (a: number) => number;
    readonly figmaapp_ungroup_selected: (a: number) => number;
    readonly figmaapp_vector_edit_exit: (a: number) => void;
    readonly figmaapp_vector_edit_get_state: (a: number) => [number, number];
    readonly figmaapp_zoom: (a: number, b: number, c: number, d: number) => void;
    readonly figmaapp_zoom_to_fit: (a: number) => number;
